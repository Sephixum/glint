...
static void test_os_weekday_to_string(void)
{
	GLINT_TEST_SECTION("os_weekday to string");

	GLINT_TEST_CHECK(string_match(string_from_os_weekday(os_weekday_sunday), string_lit_comp("sunday"), 0));
	GLINT_TEST_CHECK(string_match(string_from_os_weekday(os_weekday_monday), string_lit_comp("monday"), 0));
	GLINT_TEST_CHECK(string_match(string_from_os_weekday(os_weekday_tuesday), string_lit_comp("tuesday"), 0));
	GLINT_TEST_CHECK(string_match(string_from_os_weekday(os_weekday_wednesday), string_lit_comp("wednesday"), 0));
	GLINT_TEST_CHECK(string_match(string_from_os_weekday(os_weekday_thursday), string_lit_comp("thursday"), 0));
	GLINT_TEST_CHECK(string_match(string_from_os_weekday(os_weekday_friday), string_lit_comp("friday"), 0));
	GLINT_TEST_CHECK(string_match(string_from_os_weekday(os_weekday_saturday), string_lit_comp("saturday"), 0));
	GLINT_TEST_CHECK(string_match(string_from_os_weekday(os_weekday_COUNT), string_lit_comp("COUNT"), 0));
}
...
static void register_enum_to_string_tests(void)
{
	...
	GLINT_TEST_REGISTER(test_os_weekday_to_string);
}
